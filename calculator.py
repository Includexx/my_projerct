...
class calculator:
    def __init__(self,master):
        ...
        Button(width=11,height=4,text='8',relief='flat',bg='white',command=lambda:self.show(8)).place(x=190,y=275)
        ...
        Button(width=11,height=4,text='C',relief='flat',bg='white',command=lambda:self.show('C')).place(x=0 ,y= 350)
    ...
    def solve(self):
        resualt= eval(self.entry_value)
        self.equation.set(resualt)
